/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aa0e8df2661d71329713f9c0416d1e0c)
// Runtime types generated with workerd@1.20251001.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "OurMcp";
	}
	interface Env {
		NUXT_OPEN_AI_API_KEY: string;
		NUXT_MCP_ENDPOINT: string;
		MCP_OBJECT: DurableObjectNamespace<import("./worker/index").OurMcp>;
	}
}
